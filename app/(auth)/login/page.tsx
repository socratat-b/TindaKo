...
import { Loader2, Store, ArrowLeft, Sparkles, Shield } from 'lucide-react'
      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-100 border-2 border-orange-300 rounded-full mb-4">
            ...
            <div className="space-y-3 mb-8">
              {[
                { icon: Sparkles, text: 'No signup form needed' },
                { icon: Shield, text: 'Secure OAuth authentication' },
                { icon: Store, text: 'Start selling in 2 minutes' }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, x: -20 }}
        ...
        >
          <p className="text-sm text-gray-600">
            Walang account?{' '}
            <span className="font-bold text-orange-600">Mag-sign in lang, automatic na!</span>
          </p>
        </motion.div>
      </motion.div>
    </div>
